      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-3xl space-y-8">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-black/60 border border-gold/50">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
          <div className="flex flex-col items-center gap-2 text-gray-400">
            ...
            <div className="w-6 h-10 rounded-full border-2 border-gray-400/30 flex justify-center pt-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-400 mt-1">Find the perfect car for your lifestyle</p>
            </div>
            <Link
              href="/cars"
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {categories.map((cat) => (
              <Link
                ...
                className="group relative overflow-hidden rounded-xl bg-neutral-800 border border-neutral-700 p-6 hover:border-gold transition-all duration-300 hover:-translate-y-1"
              >
                ...
                <ChevronRight className="absolute right-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-600 group-hover:text-gold transition-colors" />
              </Link>
            ))}
          </div>
        </div>
            ...
            <VideoCard
              ...
              overlay={
                <div className="space-y-1">
                  ...
                  <p className="text-gold text-sm">Full Interior & Exterior Tour</p>
                </div>
              }
            />
            <VideoCard
              ...
              overlay={
                <div className="space-y-1">
                  ...
                  <p className="text-gold text-sm">Autopilot Demo & Features</p>
                </div>
              }
            />
          </div>
      ...
      <section className="py-20 bg-black border-t border-neutral-800">
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/sell"
              className="flex items-center gap-2 px-8 py-4 rounded-xl bg-red-600 hover:bg-red-500 text-white font-bold text-lg transition-all"
            >
